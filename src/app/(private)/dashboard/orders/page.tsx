        ...
        <div className="w-full p-5 flex flex-col gap-5 border border-zinc-200 dark:border-zinc-700 rounded-md ">
          {ordersLoading ? (
            ...
            orders.map((order) => (
              <div
                key={order.id}
                className="w-full p-5 space-y-5 dark:bg-zinc-800 rounded-md shadow-md"
              >
                {/* ===== ORDER HEADER ===== */}
                  ...
                  <div className="w-full flex flex-col gap-5">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-4">
                        ...
                        <span>{order.shipping_addresses?.recipient_name}</span>
                      </div>
                      <div className="flex items-center gap-4">
                        <FaPhone />
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                          <span>{order.shipping_addresses?.address_line}</span>
